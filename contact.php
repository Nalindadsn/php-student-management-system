...
<?php
  ...
  <section class="hero">
    <div class="background-image" style="background:url('img/contact.jpg'); background-size: cover"></div>
      ...
      <div class="form">
        ...
        <div class="contact-form">
          ...
          <form action="index.php" autocomplete="off" style="width: 100%">
            ...
            <div class="input-container textarea" style="width:100%;margin:0 25px 0 25px">
