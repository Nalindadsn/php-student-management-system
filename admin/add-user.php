...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,fullName,nameWithInitials,indexNo,intake) values('$fname','$lname','$email','$password','$contact','$fullName','$nameWithInitials','$indexNo','$intake')");
